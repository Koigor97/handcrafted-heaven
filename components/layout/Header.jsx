...
function Header() {
    ...
    useEffect(() => {
      const handleResize = () => {
          if (window.innerWidth >= 640) { // Change 640 to your breakpoint for mobile
    ...
    return (
        <>
            ...
            <div className="flex justify-between items-center bg-primary py-4 px-4">
                <div className="flex items-center gap-4 px-0">
                    <Logo className="w-10 h-auto md:w-16" />
                    <span className="text-sm md:text-lg font-bold text-gray-700 whitespace-nowrap">Handcrafted Haven</span>
                </div>
                ...
                <div className="hidden sm:flex space-x-2 justify-end">
                    <DropdownMenu open={isSignUpOpen} onOpenChange={setIsSignUpOpen}>
                        ...
                        <DropdownMenuContent className="w-45">
                            ...
                            <DropdownMenuItem asChild>
                              <Link href='/profile/user-signup'>
                                User Sign up
                              </Link>
                            </DropdownMenuItem>
                            <DropdownMenuItem asChild>
                              <Link href='/profile/artisan-signup'>
                                Artisan Sign up
                              </Link>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    ...
                    <DropdownMenu open={isLoginOpen} onOpenChange={setIsLoginOpen}>
                        ...
                        <DropdownMenuContent className="w-45">
                            ...
                            <DropdownMenuItem  asChild> 
                              <Link href='/profile/artisan-login'>
                                Artisan Login
                              </Link>
                            </DropdownMenuItem>
                        </DropdownMenuContent>
            ...
            >
                <div className="flex flex-col p-4">
                    ...
                    <div className="flex justify-center space-x-2 mb-4 mt-7">
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="outline" className="px-4 py-2 text-sm sm:text-base">
                                    Sign Up
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent className="w-45">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="default" className="px-4 py-2 text-sm sm:text-base">
                                    Login
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent className="w-45">
